...
let items = [
  ...
  { nombre: 'EMAIL_ORIGEN', valor: 'correo@omarmus.com', label: 'Remitente', descripcion: 'Email del remitente del sistema para envío de correos' },
  { nombre: 'EMAIL_HOST', valor: 'smtp.omarmus.com', label: 'Host', descripcion: 'Host del servicio de correos para envío de correos' },
